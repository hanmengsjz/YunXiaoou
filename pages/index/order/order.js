    ...
    wx.request({
      ...
      success: (res) => {
        ...
        this.setData({
          ...
          total: res.data.data.money * this.data.onLoadEvent.count * 100
        })
      }
    })
    wx.request({
      ...
      success: (res) => {
        ...
        if (app.globalData.orderCoupon != null) {
          this.setData({
            ...
            total: this.data.total - res.data.data[app.globalData.orderCoupon].subtract_money * 100
          })
        }
      },
      fail: (res) => {
  ...
  order() {
    ...
    wx.request({
      ...
      data: {
        ...
        Lced: this.data.onLoadEvent.temp * this.data.onLoadEvent.count,
        type:this.data.num
      },
      success: (res) => {
        app.showMsg('正在生成订单')
